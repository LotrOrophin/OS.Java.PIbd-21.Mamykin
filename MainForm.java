	...
	private void initialize() {
		...
		btnCreate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				((PanelSAU) panel).updateET(panel.getSize().width, panel.getSize().height);
				panel.repaint();
			}
		});
		...
		btnLeft.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				((PanelSAU) panel).MoveTransport(Direction.Left);
				panel.repaint();
			}
		});
		...
		btnDown.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				((PanelSAU) panel).MoveTransport(Direction.Down);
				panel.repaint();
			}
		});
		...
		btnRight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				((PanelSAU) panel).MoveTransport(Direction.Right);
				panel.repaint();
			}
		});
		...
		btnUp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				((PanelSAU) panel).MoveTransport(Direction.Up);
				panel.repaint();
			}
		});
